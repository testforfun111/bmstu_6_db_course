...
% Điều chỉnh độ lùi đầu dòng của mục lục
\setlength{\cftsecindent}{0em} % Lùi đầu dòng cho các mục "section"
\setlength{\cftsubsecindent}{0em} % Lùi đầu dòng cho các mục "subsection"
\setlength{\cftsubsubsecindent}{4.5em} % Lùi đầu dòng cho các mục "subsubsection"
